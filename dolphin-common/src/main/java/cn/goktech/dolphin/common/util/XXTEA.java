package cn.goktech.dolphin.common.util;
...
public final class XXTEA {
    ...
    public static final String KEY = "0x9E3559B9";
    ...
    public static final byte[] decryptBase64String(String data, byte[] key) {
        return decrypt(Base64.encodeBase64(data.getBytes()), key);
    }
    ...
    public static final String decryptBase64StringToString(String data, byte[] key) {
        try {
            byte[] bytes = decrypt(Base64.decodeBase64(data.getBytes()), key);
            if (bytes == null) return null;
            return new String(bytes, "UTF-8");
        }
        catch (UnsupportedEncodingException ex) {
    ...
    public static void main(String[] args) {
        String str = "{\"appId\":\"14DDCA532B23\",\"username\":\"admin\",\"password\":\"123456\",\"authCode\":\"090879\"," +
                "\"deviceType\":\"ios\"}";
        String key = "1234567890";
        String s = "QncB1C0rHQoZ1eRiPM4dsZtRi9pNrp7sqvX76cFXvrrIHXL6";
        String encrypt_data = XXTEA.encryptToBase64String(str,key);
        System.out.println(new String(encrypt_data));
        String decrypt_data = XXTEA.decryptBase64StringToString(s,key);
