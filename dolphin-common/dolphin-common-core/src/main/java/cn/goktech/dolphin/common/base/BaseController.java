package cn.goktech.dolphin.common.base;
...
import cn.goktech.dolphin.common.util.FantasyCollections;
...
public abstract class BaseController {
     ...
     * @return
     */
    public <T>ApiResult<T> render(ValueEnum valueEnum, T result){
     ...
     * @return
     */
    public <T>ApiResult<T> success(T result){
     ...
     * @return
     */
    public <T>ApiResult<T> failure(T result){
        return ApiResult.<T>builder().apiResultEnum(ApiResultEnum.SUCCESS).result(result).build();
    }
