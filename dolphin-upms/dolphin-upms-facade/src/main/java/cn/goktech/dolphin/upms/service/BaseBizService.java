...
import cn.goktech.dolphin.upms.enumeration.DataScopeType;
...
public abstract class BaseBizService {
    ...
    protected String dataScopeFilter(String bizAlias, String unitColumn, String userColumn) {
        DolUserDTO user = SecurityUtils.getUser();
    ...
    protected boolean isSuperAdmin() {
        ...
        if (SecurityUtils.getUser() == null){
            ...
            return VariableUtils.cast(data.getValue(), Long.class).equals(SecurityUtils.getUser().getId());
        }
    }
}
